...
namespace CPU {
    class CPUIns {
        ...
        public void SAVE() {
            ...
            string input = Console.ReadLine();
            string FolderPath = "/storage/emulated/0/simplecpu";
            string FilePath = "/storage/emulated/0/simplecpu/persistentmemory.scpu";
        ...
        public void STRSAVE() {
            ...
            string input = Console.ReadLine();
            string FolderPath = "/storage/emulated/0/simplecpu";
            string FilePath = "/storage/emulated/0/simplecpu/stringmemory.scpu";
            if (!System.IO.Directory.Exists(FolderPath)) {
                System.IO.Directory.CreateDirectory(FolderPath);
            }
            if (!System.IO.File.Exists(FilePath)) {
        ...
        public void MSTRSAVE() {
            ...
            string FolderPath = "/storage/emulated/0/simplecpu";
            string FilePath = "/storage/emulated/0/simplecpu/mstringmemory.scpu";
            if (!System.IO.Directory.Exists(FolderPath)) {
                System.IO.Directory.CreateDirectory(FolderPath);
            }
            if (!System.IO.File.Exists(FilePath)) {
        ...
        public void MSAVE() {
            ...
            string FolderPath = "/storage/emulated/0/simplecpu";
            string FilePath = "/storage/emulated/0/simplecpu/mpersistentmemory.scpu";
            if (!System.IO.Directory.Exists(FolderPath)) {
                System.IO.Directory.CreateDirectory(FolderPath);
            }
            if (!System.IO.File.Exists(FilePath)) {
        ...
        public void PCSHOW() {
            Console.WriteLine($"PC is at: {PC}");
        }
        public void FIB() {
            BigInteger n1 = 0, n2 = 1, n3 = 0;
            string input = Console.ReadLine();
            if (int.TryParse(input, out int inputp)) {
                if (inputp == 0) { Console.WriteLine($"Number After {inputp} iterations: 0"); return; }
                if (inputp == 1) { Console.WriteLine($"Number After {inputp} iteration: 1"); return; }
                if (inputp >= 15000) { Console.WriteLine("iterations too large! use iterations below 15000"); return; }
                for (int j = 0; j < inputp; j++) {
                    n3 = n1 + n2;
                    n1 = n2;
                    n2 = n3;
                }
                Console.WriteLine($"Number After {inputp} iterations: {n2}");
            }
        }
        public void FIBF() {
            string FolderPath = "/storage/emulated/0/simplecpu";
            string FilePath = "/storage/emulated/0/simplecpu/fib.scpu";
            if (!System.IO.Directory.Exists(FolderPath)) {
                System.IO.Directory.CreateDirectory(FolderPath);
            }
            if (!System.IO.File.Exists(FilePath)) {
            ...
            if (int.TryParse(input, out int inputp)) {
                if (inputp == 0) { Console.WriteLine($"Number After {inputp} iterations: 0"); return; }
                if (inputp == 1) { Console.WriteLine($"Number After {inputp} iteration: 1"); return; }
                for (int j = 2; j < inputp; j++) {
                    n3 = n1 + n2;
                    n1 = n2;
                    n2 = n3;
                }
                System.IO.File.WriteAllText(FilePath, n2.ToString());
                Console.WriteLine($"Sucfesfully Copied Fib to {FilePath}");
            }
        }
        public void SHOWOPCODES() {
            ...
            Console.WriteLine("0x009 = Fibonacci for N amount of iterations");
            ...
            Console.WriteLine("0x056 = show PC (program counter) aka how many programs you executed");
            ...
            Console.WriteLine("0x204 = write Fibonacci to persistent storage (use for large iterations)");
        }
        public void RUN() {
            while (true) {
                ...
                if (opcodemain == "0x000") {
                    ...
                    SHOWOPCODES();
                } else if (opcodemain == "0x056") {
                    PCSHOW();
                } else if (opcodemain == "0x009") {
                    FIB();
                } else if (opcodemain == "0x204") {
                    FIBF();
                } else {
