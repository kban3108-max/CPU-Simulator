...
how to use tutorial:
1. downlaod the APK (if your looking for how to use the source code then scroll down to tutorial 2 or if you want to use the DLL go to tutorial 3)
2. install it
3. give it all file access and notifications (this is device dependent)
4. enjoy
